...
// CacheConfig itself moved to `config.rs` — this module keeps the always-
// compiled cache-key / policy logic that operates on it.
...
/// semantics — the two crates (`conduit-core`, `conduit-cache`, #135) still
/// each own their own `path_matches` after this extraction, unchanged.
...
#[cfg(feature = "cache")]
pub fn should_early_refresh(remaining_secs: u64, early_window_secs: u32) -> bool {
