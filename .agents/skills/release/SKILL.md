...
- `scrum-master`: append a "Реализовано в сессии <date>" entry to `AGENTS.md` if the release
...
Same heuristic as routine CI triage (see `release-engineer`, `.Codex/rules/index.md`): a `curl
