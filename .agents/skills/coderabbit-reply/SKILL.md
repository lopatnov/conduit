...
> Extracted 2026-08-28 from `.Codex/rules/conventions.md` (see "New `.Codex/` process
...
> practice — see `.Codex/rules/index.md` "GitHub access differs by execution context"), so
...
A local session (see `.Codex/rules/index.md` "GitHub access differs by execution
...
`.Codex/rules/conventions.md` "PR checklist" for where this fits in the merge gate, and
`.Codex/rules/index.md` "PR review & CI triage" for the caveat that a bot re-posting an
