---
name: "source-command-fast-follow-check"
...
# source-command-fast-follow-check

Use this skill when the user asks to run the migrated source command `fast-follow-check`.
...
Before pulling from the general backlog (GitHub issue list, `AGENTS.md` backlog
