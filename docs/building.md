...
(`default = ["compression", "static"]`) — core reverse proxy, TLS, static files, rate
...
The default build (`default = ["compression", "static"]`) is the minimal embed-friendly
...
```bash
# Minimal image (default = ["compression", "static"])
