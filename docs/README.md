...
| ------------------------------------ | -------------------------------------------------------------------------- |
| [configuration.md](configuration.md) | Full reference — every field, YAML and JSON, with field tables             |
| [recipes.md](recipes.md)             | Ready-to-use configs by scenario (HTTPS, JWT, load balancing, security, …) |
| [cli.md](cli.md)                     | All CLI commands, flags, and all 14 build features                         |
